 ...
 *
 * TODO Similar functionality is part of lib-hellotter-app. This function should be
...
function _shouldMirror(track) {
    return (
        track
            ...
            // well, it's defined by lib-hellotter-app. Note though that the type
            // of the value on the right side of the equality check is defined
            // by hellotter-app. The type definitions are surely compatible today
