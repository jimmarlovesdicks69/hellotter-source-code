 ...
 * lib-hellotter-app but some of its properties are consumed by the application
 * hellotter-app as well.
 *
 * {
 *     type: SET_CONFIG,
 *     config: Object
 ...
 * base/config. The configuration is defined and consumed by the library
 * lib-hellotter-app but some of its properties are consumed by the application
 * hellotter-app as well. A merge operation is performed between the existing config
