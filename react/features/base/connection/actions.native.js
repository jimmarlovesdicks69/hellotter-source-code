 ...
 * the extent that hellotter-app needs it).
 */
...
export function connect(id: ?string, password: ?string) {
    return (dispatch: Dispatch<any>, getState: Function) => {
         ...
         * @param {string} [msg] - Error message supplied by lib-hellotter-app.
            ...
            promise
                = conference_.leave()
                    .catch(error => {
                        ...
                        // The library lib-hellotter-app failed to make the
                        ...
                        // hellotter-app as if the leave has succeeded.
