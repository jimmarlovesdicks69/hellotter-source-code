...
type Props = {
    ...
    /**
     * The JitsiConference's connection state. It's the lib-hellotter-app's event
...
/**
 * The component will expose some of the app state to the hellotter-app-torture
...
class TestConnectionInfo extends Component<Props, State> {
     ...
     * the lib-hellotter-app for more details on the actual structure or add
