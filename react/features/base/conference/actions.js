...
function _addConferenceListeners(conference, dispatch) {
    ...
    conference.on(
        ...
        () => {
            ...
            // XXX Jicofo tells lib-hellotter-app to start with audio and/or video
            // muted i.e. Jicofo expresses an intent. Lib-hellotter-app has turned
            ...
            // transfer that intent to lib-hellotter-app instead of lib-hellotter-app
 ...
 * lib-hellotter-app and not the application.
 *
