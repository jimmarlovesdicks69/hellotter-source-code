...
export function _addLocalTracksToConference(
    ...
    for (const track of localTracks) {
        // XXX The library lib-hellotter-app may be draconian, for example, when
...
/**
 * Handle an error thrown by the backend (i.e. {@code lib-hellotter-app}) while
...
export function _handleParticipantError(err: { message: ?string }) {
    ...
    // TODO Lib-hellotter-app should be fixed to not throw such an exception in
    // these scenarios.
