...
export function disposeLib() {
    return (dispatch: Dispatch<any>) => {
        ...
        // TODO Currently, lib-hellotter-app doesn't have the functionality to
        // dispose itself.
...
/**
 * Initializes lib-hellotter-app (i.e. {@link invokes JitsiMeetJS.init()}) with the
...
export function initLib() {
    return (dispatch: Dispatch<any>, getState: Function): void => {
        ...
        if (!config) {
            throw new Error('Cannot init lib-hellotter-app without config');
        }
