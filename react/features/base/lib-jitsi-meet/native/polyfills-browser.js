...
// XXX The library lib-hellotter-app utilizes window.localStorage at the time of
// this writing and, consequently, the browser-related polyfills implemented
// here by the feature base/lib-hellotter-app for the purposes of the library
// lib-hellotter-app are incomplete without the Web Storage API! Should the library
// lib-hellotter-app (and its dependencies) stop utilizing window.localStorage,
...
(global => {
    ...
    //
    // Required by:
    // - lib-hellotter-app requires this if using WebSockets
    ...
    if (typeof global.document === 'undefined') {
        ...
        //
        // Required by:
        // - lib-hellotter-app/modules/xmpp
        ...
        if (elementPrototype) {
            ...
            //
            // Required by:
            // - lib-hellotter-app ChatRoom#onPresence parsing
    ...
    if (typeof global.location === 'undefined') {
        global.location = {
            ...
            // Required by:
            // - lib-hellotter-app/modules/xmpp/xmpp.js
            search: ''
        };
    }
    ...
    if (navigator) {
        ...
        //
        // Required by:
        // - lib-hellotter-app/modules/browser/BrowserDetection.js
