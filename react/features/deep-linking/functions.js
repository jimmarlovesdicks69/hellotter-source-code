...
export function generateDeepLinkingURL() {
    ...
    const appScheme = interfaceConfig.APP_SCHEME || 'com.hellotter.app';
    ...
    if (Platform.OS === 'android') {
        // https://meet.jit.si/foo -> app.jit.si/foo
        const url = href.replace(regex, '').substr(2);
        const pkg = interfaceConfig.ANDROID_APP_PACKAGE || 'com.hellotter.app';
