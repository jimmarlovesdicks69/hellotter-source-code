...
class GoogleAnalyticsHandler extends AbstractHandler {
     ...
     * from a lib-hellotter-app analytics event.
     *
     * @param {Object} event - The lib-hellotter-app analytics event.
     * @returns {number} - The integer to use for the 'value' of a Google
     * analytics event, or NaN if the lib-hellotter-app event doesn't contain a
     * suitable value.
     * @private
     */
    _extractValue(event) {
     ...
     * analyticsAdapter in lib-hellotter-app.
     *
