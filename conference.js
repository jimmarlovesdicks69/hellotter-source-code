 ...
 * lib-hellotter-app to detect and invoke
 */
...
/**
 * Handles CONNECTION_FAILED events from lib-hellotter-app.
 *
...
export default {
     ...
     * or if it was disabled through lib-hellotter-app specific options (check
     ...
     *
     * NOTE: Used by hellotter-app-torture!
     */
    listMembers() {
     ...
     * decision whether the Command(s) API of room (i.e. lib-hellotter-app's
    ...
    /**
     * Handles {@link JitsiTrackError} returned by the lib-hellotter-app when
