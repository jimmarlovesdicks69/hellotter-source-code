...
RELEASE_REPO=$(realpath ${THIS_DIR}/../../../hellotter-app-ios-sdk-releases)
...
xcodebuild -workspace ios/hellotter-app.xcworkspace -scheme JitsiMeet -destination='generic/platform=iOS' -configuration Release ENABLE_BITCODE=NO clean archive
